...
| [Authentication](authentication.md) | Accepted | An identity provider, browser trust boundary, or session policy changes |

Design changes require an update to the affected document and a Beads decision
or implementation issue. Status and sequencing remain in Beads.
